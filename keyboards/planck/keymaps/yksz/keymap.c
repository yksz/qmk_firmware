 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Fn   | Ctrl | GUI  | Alt  |Lower |    Space    |Raise | Alt  | GUI  | Ctrl | Fn   |
 * `-----------------------------------------------------------------------------------'
 *
 * Default
 * ,-----------------------------------------------------------------------------------.
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    FUNCTION,KC_LCTL, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RALT, KC_RGUI, KC_RCTL, FUNCTION
),
...
[_NUMPAD] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, KC_P0,   KC_PDOT, KC_PENT, KC_NLCK
),
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |  F11 |  F12 |PrtSc |      |      | Left | Down |  Up  |Right |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_FUNCTION] = LAYOUT_planck_grid(
    ...
    _______, KC_F11,  KC_F12,  KC_PSCR, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_TAB,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS,    KC_PLUS,    KC_LCBR, KC_RCBR, KC_QUOT,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END,  KC_BSLS,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_TAB,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_DQUO,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, KC_PIPE,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
