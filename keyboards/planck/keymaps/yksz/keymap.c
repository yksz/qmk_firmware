 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  Fn  | Ctrl | GUI  | Alt  |Lower |AltSpc|FnSpc |Raise | Alt  | GUI  | Ctrl |  Fn  |
 * `-----------------------------------------------------------------------------------'
 *
 * Default
 * ,-----------------------------------------------------------------------------------.
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    FN,      KC_LCTL, KC_LGUI, KC_LALT, LOWER,   ALT_SPC, FN_SPC,  RAISE,   KC_RALT, KC_RGUI, KC_RCTL, FN
),
...
[_LOWER] = LAYOUT_planck_grid(
    KC_TILD, _______, _______, _______, _______, _______, KC_PSLS, KC_P7,   KC_P8,   KC_P9,   KC_PMNS, KC_DEL,
    KC_TAB,  _______, _______, _______, _______, _______, KC_PAST, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, _______,
    _______, _______, _______, _______, _______, _______, KC_PEQL, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______,
    _______, _______, _______, _______, _______, _______, _______, KC_P0,   KC_P0,   KC_PDOT, KC_PENT, KC_NLCK
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_TAB,  _______, _______, _______, _______, _______, KC_PIPE, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
 ...
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|Audoff|AGnorm|AGswap|Qwerty|NumPad|      |      |Brite |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  NUMPAD,   _______, _______, BACKLIT,
